...
- [Lezione 000 - Toolchain e setup del progetto](modulo-0/lessons/001-toolchain-setup.md)
- [Lezione 032 - Git e GitHub: versionamento e collaborazione](modulo-0/lessons/002-git-github.md)
- [Lezione 033 - VS Code: setup e debugging Assembly](modulo-0/lessons/003-vs-code-setup.md)
- [Lezione 034 - VICE: configurazione e immagini disco](modulo-0/lessons/004-vice-immagini-disco.md)
- [Lezione 035 - Automazione: Makefile e task build](modulo-0/lessons/005-automazione-makefile.md)
## Obiettivo
